...
message(STATUS "Third-party (external): creating target 'CoMISo::CoMISo'")
...
set(output_folder "${CMAKE_CURRENT_BINARY_DIR}/CoMISo")
...
target_include_directories(CoMISo PUBLIC ${CMAKE_CURRENT_BINARY_DIR})
